(() => {
  // node_modules/butterchurn/dist/butterchurn.js
  {
...
`) {
          ...
          lineStart = i + 1;
          emitAnchor = true;
        } else if (blockComment && char === "*" && src2[i + 1] === "/") {
          blockComment = false;
          i++;
          emitAnchor = true;
        } else if (char === "\\" && src2[i + 1] === "\\" || char === "/" && src2[i + 1] === "/") {
          inlineComment = true;
          i++;
        } else if (char === "/" && src2[i + 1] === "*") {
          blockComment = true;
          i++;
      ...
      var parser2 = function() {
        var o = function(k, v, o2, l) {
          for (o2 = o2 || {}, l = k.length;l--; o2[k[l]] = v)
            ;
          return o2;
        }, $V0 = [1, 18], $V1 = [1, 7], $V2 = [1, 19], $V3 = [1, 20], $V4 = [1, 14], $V5 = [1, 15], $V6 = [1, 16], $V7 = [1, 33], $V8 = [1, 31], $V9 = [1, 23], $Va = [1, 22], $Vb = [1, 24], $Vc = [1, 25], $Vd = [1, 26], $Ve = [1, 27], $Vf = [1, 28], $Vg = [1, 29], $Vh = [1, 30], $Vi = [5, 8, 15, 18, 20, 28, 29, 32, 33, 34, 35, 36, 37, 38], $Vj = [5, 15, 18], $Vk = [5, 12, 15, 17, 18, 24, 25, 28, 29, 30], $Vl = [1, 57], $Vm = [5, 8, 12, 15, 17, 18, 24, 25, 28, 29, 30], $Vn = [15, 18], $Vo = [5, 8, 15, 18, 28, 29, 38], $Vp = [5, 8, 15, 18, 28, 29, 32, 33, 38], $Vq = [5, 8, 15, 18, 28, 29, 32, 33, 34, 37, 38], $Vr = [5, 8, 15, 18, 28, 29, 32, 33, 34, 35, 36, 37, 38], $Vs = [5, 8, 15, 18], $Vt = [5, 8, 15, 18, 20, 22, 28, 29, 32, 33, 34, 35, 36, 37, 38];
        var parser3 = {
    ...
    function mapAst(ast, cb) {
      ...
      children.forEach((child) => {
        if (child.type === "NODE") {
          ...
          const childrenHaveChanged = orignalChildren.some((child2, i) => child2 !== newChildren[i]);
...
`)[3]}`, mapLoc(e.hash.loc, mapper), code);
  ...
  function requireEncoding() {
    ...
    (function(exports) {
      var __importStar = encoding && encoding.__importStar || function(mod2) {
      ...
      const ieee7542 = __importStar(requireIeee754());
      const utils_1 = requireUtils();
      exports.MAGIC = [0, 97, 115, 109];
      exports.WASM_VERSION = [1, 0, 0, 0];
      ...
      exports.op = {
        block: (blockType) => [2, blockType],
        loop: (blockType) => [3, blockType],
        if: (retType) => [4, retType],
        else: 5,
        end: 11,
        br_if: (i) => [13, ...unsignedLEB128(i)],
        call: (i) => [16, ...unsignedLEB128(i)],
        drop: 26,
        select: 27,
        local_get: (i) => [32, ...unsignedLEB128(i)],
        local_set: (i) => [33, ...unsignedLEB128(i)],
        local_tee: (i) => [34, ...unsignedLEB128(i)],
        global_get: (i) => [35, ...unsignedLEB128(i)],
        global_set: (i) => [36, ...unsignedLEB128(i)],
        ...
        i32_const: (i) => [65, ...signedLEB128(i)],
        f64_const: (i) => [68, ...encodef64(i)],
        i32_eqz: 69,
        i32_ne: 71,
        i32_lt_s: 72,
        i32_lt_u: 73,
      ...
      exports.FUNCTION_TYPE = 96;
      exports.MEMORY_IDX = 2;
      exports.GLOBAL_TYPE = 3;
      exports.TYPE_IDX = 0;
      exports.IS_ZEROISH = [
        exports.op.f64_abs,
  ...
  function requireShims() {
    ...
    const shims$1 = {
      ...
      sigmoid: function(x, y) {
        ...
        return Math.abs(t) > EPSILON2 ? 1 / t : 0;
      }
    };
  ...
  function requireWasmFunctions() {
    ...
    wasmFunctions.localFuncMap = {
      ...
      _getBufferIndex: {
        args: [encoding_1.VAL_TYPE.f64],
        returns: [encoding_1.VAL_TYPE.i32],
        localVariables: [
  ...
  function requireEmitter() {
    ...
    var __importDefault = emitter && emitter.__importDefault || function(mod2) {
    ...
    function emit(ast, context) {
      ...
      switch (ast.type) {
        ...
        case "CALL_EXPRESSION": {
          ...
          switch (functionName) {
            ...
            case "gmegabuf":
              ...
              return [
                ...
                ...(_a = context.resolveFunc("_getBufferIndex")) !== null && _a !== undefined ? _a : [],
          ...
          if (invocation == null || functionName.startsWith("_")) {
        ...
        case "ASSIGNMENT_EXPRESSION": {
          ...
          if (left.type !== "CALL_EXPRESSION") {
            throw errorUtils_1.createCompilerError(`Unexpected left hand side type for assignment: ${left.type}`, ast.loc, context.rawSource);
          }
          ...
          if (mutationCode === null) {
            ...
            const rightValue2 = context.resolveLocal(encoding_1.VAL_TYPE.f64);
            return [
              ...rightCode,
              ...encoding_1.op.local_set(rightValue2),
              ...emit(left.arguments[0], context),
              ...(_b = context.resolveFunc("_getBufferIndex")) !== null && _b !== undefined ? _b : [],
              ...
              ...encoding_1.op.local_get(rightValue2),
          ...
          return [
            ...
            ...emit(left.arguments[0], context),
            ...(_c = context.resolveFunc("_getBufferIndex")) !== null && _c !== undefined ? _c : [],
            ...encoding_1.op.local_tee(index),
            ...encoding_1.op.i32_const(-1),
            encoding_1.op.i32_ne,
        ...
        default:
          throw errorUtils_1.createCompilerError(`Unknown AST node type ${ast.type}`, ast.loc, context.rawSource);
      }
    }
    emitter.emit = emit;
  ...
  function requireCompiler() {
    ...
    var __importDefault = compiler && compiler.__importDefault || function(mod2) {
      return mod2 && mod2.__esModule ? mod2 : { default: mod2 };
    };
    var __importStar = compiler && compiler.__importStar || function(mod2) {
      if (mod2 && mod2.__esModule)
        return mod2;
      var result = {};
      if (mod2 != null) {
    ...
    function compileModule({ pools, functions: funcs, eelVersion = 2, preParsed = false }) {
      ...
      Object.entries(funcs).forEach(([name, { pool, code }]) => {
        if (pools[pool] == null) {
          ...
          if (poolsList.length === 0) {
            throw new Error(`The function "${name}" was declared as using a variable ` + `pool named "${pool}" but no pools were defined.`);
          }
          throw new Error(`The function "${name}" was declared as using a variable ` + `pool named "${pool}" which is not among the variable ` + `pools defined. The defined variable pools are: ` + `${Utils.formatList(poolsList)}.`);
        }
        ...
        const context = {
          resolveVar: (name2) => {
            if (/^reg\d\d$/.test(name2)) {
              return varResolver.get(null, name2);
            }
            return varResolver.get(pool, name2);
          },
          resolveLocal: (type) => {
          ...
          resolveFunc: (name2) => {
            const shimdex = functionImports.findIndex((func) => func.name === name2);
            if (shimdex !== -1) {
              const call = encoding_1.op.call(shimdex);
              if (name2 === "rand" && eelVersion === 1) {
                return [...call, encoding_1.op.f64_floor];
              }
              return call;
            }
            if (wasmFunctions_1.localFuncMap[name2] == null) {
              return null;
            }
            let index = localFuncOrder.indexOf(name2);
            if (index === -1) {
              localFuncOrder.push(name2);
      ...
      const codes = [...localFuncs, ...moduleFuncs].map((func) => {
        var _a;
        const localTypes = ((_a = func.localVariables) !== null && _a !== undefined ? _a : []).map((type) => {
  ...
  function requireLoader() {
    if (hasRequiredLoader)
      return loader;
    hasRequiredLoader = 1;
    var __importDefault = loader && loader.__importDefault || function(mod2) {
      return mod2 && mod2.__esModule ? mod2 : { default: mod2 };
    };
    ...
    async function loadModule({ pools, functions, eelVersion = 2 }) {
      ...
      const mod2 = await WebAssembly.compile(buffer);
      var importObject = Object.assign(Object.assign({}, pools), { shims: shims_1.default });
      return await WebAssembly.instantiate(mod2, importObject);
    }
  ...
  function requireSrc() {
    if (hasRequiredSrc)
      return src;
    hasRequiredSrc = 1;
    var __importDefault = src && src.__importDefault || function(mod2) {
      return mod2 && mod2.__esModule ? mod2 : { default: mod2 };
    };
  ...
  var THIS = Symbol();
  var STRING_DECODE_THRESHOLD = 32;
  ...
  function postInstantiate(extendedExports, instance) {
    ...
    const __rtti_base = exports["__rtti_base"] || -1;
    function getInfo(id) {
    ...
    function __newArray(id, values) {
      ...
      if (info & VAL_MANAGED) {
        for (let i = 0;i < length; ++i)
          view[(buf >>> align) + i] = __retain(values[i]);
      } else {
  ...
  function isResponse(src2) {
    return typeof Response !== "undefined" && src2 instanceof Response;
  }
  function isModule(src2) {
    return src2 instanceof WebAssembly.Module;
  }
  ...
  class FFT {
    ...
    initEqualizeTable() {
      ...
      const invHalfNFREQ = 1 / this.samplesOut;
    ...
    updateAudioLevels(fps, frame) {
      if (this.audio.freqArray.length > 0) {
        ...
        for (let i = 0;i < 3; i++) {
          ...
          rate = AudioLevels.adjustRateToFPS(rate, 30, effectiveFPS);
...
`
  ...
  class SeededRandom {
    ...
    static initializeState(state, seed) {
      state[0] = seed;
      state[1] = seed ^ 2654435769;
      state[2] = seed ^ 1779033703;
      state[3] = seed ^ 3144134277;
    }
    warmUp() {
      for (let i = 0;i < 10; i++) {
        this.next();
  ...
  class PresetEquationRunner {
    ...
    initializeEquations(globalVars) {
      ...
      const initUserVars = Utils.pick(mdVSAfterInit, Object.keys(Utils.omit(mdVSAfterInit, nonUserKeys)));
  ...
  class BasicWaveform {
    ...
    static processWaveform(timeArray, mdVSFrame) {
      const waveform = [];
      const scale = mdVSFrame.wave_scale / 128;
      const smooth = mdVSFrame.wave_smoothing;
      const smooth2 = scale * (1 - smooth);
    ...
    generateWaveform(blending, blendProgress, timeArrayL, timeArrayR, mdVSFrame) {
      ...
      const vol = (mdVSFrame.bass + mdVSFrame.mid + mdVSFrame.treb) / 3;
      if (vol > -0.01 && alpha > 0.001 && timeArrayL.length > 0) {
        ...
        const wavePosX = mdVSFrame.wave_x * 2 - 1;
        const wavePosY = mdVSFrame.wave_y * 2 - 1;
        this.numVert = 0;
        this.oldNumVert = 0;
        ...
        for (let it = 0;it < its; it++) {
          ...
          if (waveMode === 0) {
            ...
            for (let i = 0;i < numVert - 1; i++) {
              ...
              if (i < numVert / 10) {
                let mix3 = i / (numVert * 0.1);
                mix3 = 0.5 - 0.5 * Math.cos(mix3 * Math.PI);
                const rad2 = 0.5 + 0.4 * waveR[i + numVert + sampleOffset] + fWaveParam2;
                rad = (1 - mix3) * rad2 + rad * mix3;
              }
            ...
            const numVertInv = 1 / numVert;
            const sampleOffset = Math.floor((waveL.length - numVert) / 2);
            const w1 = 0.45 + 0.5 * (fWaveParam2 * 0.5 + 0.5);
            const w2 = 1 - w1;
            for (let i = 0;i < numVert; i++) {
              let x = 2 * i * numVertInv + (wavePosX - 1) + waveR[(i + 25 + sampleOffset) % waveL.length] * 0.44;
              let y = waveL[i + sampleOffset] * 0.47 + wavePosY;
              if (i > 1) {
                x = x * w2 + w1 * (positions[(i - 1) * 3 + 0] * 2 - positions[(i - 2) * 3 + 0]);
                y = y * w2 + w1 * (positions[(i - 1) * 3 + 1] * 2 - positions[(i - 2) * 3 + 1]);
              }
              positions[i * 3 + 0] = x;
              positions[i * 3 + 1] = y;
              positions[i * 3 + 2] = 0;
            ...
            let dy = Math.sin(ang);
            const edgex = [
              wavePosX * Math.cos(ang + Math.PI * 0.5) - dx * 3,
              wavePosX * Math.cos(ang + Math.PI * 0.5) + dx * 3
            ];
            const edgey = [
              wavePosX * Math.sin(ang + Math.PI * 0.5) - dy * 3,
              wavePosX * Math.sin(ang + Math.PI * 0.5) + dy * 3
            ];
            for (let i = 0;i < 2; i++) {
              for (let j = 0;j < 4; j++) {
    ...
    generateWaveform(timeArrayL, timeArrayR, freqArrayL, freqArrayR, globalVars, presetEquationRunner, waveEqs, alphaMult) {
      if (waveEqs.baseVals.enabled !== 0 && timeArrayL.length > 0) {
        ...
        if (this.samples >= 2 || usedots !== 0 && this.samples >= 1) {
          ...
          if (usedots === 0) {
            WaveUtils.smoothWaveAndColor(this.positions, this.colors, this.smoothedPositions, this.smoothedColors, this.samples);
          }
          return true;
        }
      }
  ...
  var CustomShape$1 = class CustomShape {
    constructor(index, gl, opts) {
      this.index = index;
      this.gl = gl;
      const maxSides = 101;
    ...
    drawCustomShape(blendProgress, globalVars, presetEquationRunner, shapeEqs, prevTexture) {
      if (shapeEqs.baseVals.enabled !== 0) {
        if (!presetEquationRunner.preset.useWASM) {
          ...
          Utils.setWasm(varPool, presetEquationRunner.mdVSTShapeInits[this.index], presetEquationRunner.ts);
  ...
  class MotionVectors {
    ...
    generateMotionVectors(mdVSFrame, warpUVs) {
      ...
      if (mvA > 0.001 && nX > 0 && nY > 0) {
        ...
        const minLen = 1 / this.texsizeX;
        this.numVecVerts = 0;
        for (let j = 0;j < nY; j++) {
          let fy = (j + 0.25) / (nY + dy + 0.25 - 1);
          fy -= dy2;
          if (fy > 0.0001 && fy < 0.9999) {
            for (let i = 0;i < nX; i++) {
              let fx = (i + 0.25) / (nX + dx + 0.25 - 1);
              fx += dx2;
  ...
  class WarpShader {
    ...
    renderQuadTexture(blending, texture, blurTexture1, blurTexture2, blurTexture3, blurMins, blurMaxs, mdVSFrame, mdVSQs, warpUVs, warpColor) {
      ...
      this.gl.uniform4fv(this.roamCosLoc, [
        ...
        0.5 + 0.5 * Math.cos(mdVSFrame.time * 5),
        0.5 + 0.5 * Math.cos(mdVSFrame.time * 20)
      ]);
      ...
      this.gl.uniform4fv(this.roamSinLoc, [
        ...
        0.5 + 0.5 * Math.sin(mdVSFrame.time * 5),
        0.5 + 0.5 * Math.sin(mdVSFrame.time * 20)
      ]);
  ...
  class BlurVertical {
    constructor(gl, blurLevel) {
      ...
      const w = [4, 3.8, 3.5, 2.9, 1.9, 1.2, 0.7, 0.3];
    ...
    renderQuadTexture(texture, mdVSFrame, srcTexsize) {
      ...
      this.gl.bindTexture(this.gl.TEXTURE_2D, texture);
      this.gl.uniform1i(this.textureLoc, 0);
      const b1ed = this.blurLevel === 0 ? mdVSFrame.b1ed : 0;
  ...
  class Noise {
    ...
    static dwCubicInterpolate(y0, y1, y2, y3, t) {
      const ret = [];
      for (let i = 0;i < 4; i++) {
        let f = Noise.fCubicInterpolate(y0[i] / 255, y1[i] / 255, y2[i] / 255, y3[i] / 255, t);
        f = Math.clamp(f, 0, 1);
        ret[i] = f * 255;
      }
      return ret;
  ...
  class BlendPattern {
    ...
    genPlasma(x0, x1, y0, y1, dt) {
      ...
      if (y1 - y0 >= 2) {
        if (x0 === 0) {
          this.vertInfoC[midy * (this.mesh_width + 1) + x0] = 0.5 * (t00 + t10) + (this.rng.random() * 2 - 1) * dt * this.aspecty;
        }
        this.vertInfoC[midy * (this.mesh_width + 1) + x1] = 0.5 * (t01 + t11) + (this.rng.random() * 2 - 1) * dt * this.aspecty;
      }
      if (x1 - x0 >= 2) {
        if (y0 === 0) {
          this.vertInfoC[y0 * (this.mesh_width + 1) + midx] = 0.5 * (t00 + t01) + (this.rng.random() * 2 - 1) * dt * this.aspectx;
        }
        this.vertInfoC[y1 * (this.mesh_width + 1) + midx] = 0.5 * (t10 + t11) + (this.rng.random() * 2 - 1) * dt * this.aspectx;
      }
      if (y1 - y0 >= 2 && x1 - x0 >= 2) {
        ...
        this.vertInfoC[midy * (this.mesh_width + 1) + midx] = 0.25 * (t10 + t11 + t00 + t01) + (this.rng.random() * 2 - 1) * dt;
    ...
    createBlendPattern() {
      ...
      if (mixType === 0) {
        ...
        const band2 = 0.1 + 0.2 * this.rng.random();
        const invBand = 1 / band2;
        let nVert = 0;
        for (let y = 0;y <= this.mesh_height; y++) {
          ...
          for (let x = 0;x <= this.mesh_width; x++) {
            ...
            this.vertInfoA[nVert] = invBand * (1 + band2);
            this.vertInfoC[nVert] = -invBand + invBand * t;
            nVert += 1;
          }
        }
      } else if (mixType === 2) {
        const band2 = 0.12 + 0.13 * this.rng.random();
        const invBand = 1 / band2;
        ...
        const band2 = 0.02 + 0.14 * this.rng.random() + 0.34 * this.rng.random();
        const invBand = 1 / band2;
  ...
  class Renderer {
    constructor(gl, audio, opts) {
      ...
      this.darkenCenter = new CustomShape2(gl, params);
    ...
    calcTimeAndFPS(elapsedTime) {
      ...
      if (elapsedTime) {
        ...
        elapsed = (newTime - this.lastTime) / 1000;
    ...
    runPixelEquations(presetEquationRunner, mdVSFrame, globalVars, blending) {
      ...
      const warpScaleInv = 1 / mdVSFrame.warpscale;
      const warpf0 = 11.68 + 4 * Math.cos(warpTimeV * 1.413 + 10);
      const warpf1 = 8.77 + 3 * Math.cos(warpTimeV * 1.113 + 7);
      const warpf2 = 10.54 + 3 * Math.cos(warpTimeV * 1.233 + 3);
      const warpf3 = 11.49 + 4 * Math.cos(warpTimeV * 0.933 + 5);
      const texelOffsetX = 0 / this.texsizeX;
      const texelOffsetY = 0 / this.texsizeY;
      ...
      if (!presetEquationRunner.preset.useWASM) {
        ...
        if (!blending) {
          ...
          for (let iz = 0;iz < gridZ1; iz++) {
            for (let ix = 0;ix < gridX1; ix++) {
              const u = newWarpUVs[offset2];
              const v = newWarpUVs[offset2 + 1];
              let mix2 = this.blendPattern.vertInfoA[offset2 / 2] * this.blendProgress + this.blendPattern.vertInfoC[offset2 / 2];
              mix2 = Math.clamp(mix2, 0, 1);
              this.warpUVs[offset2] = this.warpUVs[offset2] * mix2 + u * (1 - mix2);
              this.warpUVs[offset2 + 1] = this.warpUVs[offset2 + 1] * mix2 + v * (1 - mix2);
              this.warpColor[offsetColor2 + 0] = 1;
              this.warpColor[offsetColor2 + 1] = 1;
              this.warpColor[offsetColor2 + 2] = 1;
              this.warpColor[offsetColor2 + 3] = mix2;
              offset2 += 2;
              offsetColor2 += 4;
            }
          }
      ...
      if (this.blending) {
        if (this.prevPreset.shapes && this.prevPreset.shapes.length > 0) {
          this.prevCustomShapes.forEach((shape, i) => {
            shape.drawCustomShape(1 - this.blendProgress, prevGlobalVars, this.prevPresetEquationRunner, this.prevPreset.shapes[i], this.prevTexture);
          });
        }
        if (this.prevPreset.waves && this.prevPreset.waves.length > 0) {
          this.prevCustomWaveforms.forEach((waveform, i) => {
            waveform.drawCustomWaveform(1 - this.blendProgress, this.audio.timeArrayL, this.audio.timeArrayR, this.audio.freqArrayL, this.audio.freqArrayR, prevGlobalVars, this.prevPresetEquationRunner, this.prevPreset.waves[i]);
          });
        }
      }
    ...
    toDataURL() {
      ...
      Array.from({ length: this.texsizeY }, (val, i) => data.slice(i * this.texsizeX * 4, (i + 1) * this.texsizeX * 4)).forEach((val, i) => data.set(val, (this.texsizeY - i - 1) * this.texsizeX * 4));
  ...
  class Visualizer {
    ...
    createPerFramePool(baseVals) {
      ...
      Object.keys(this.baseValsDefaults).forEach((key) => {
        wasmVars[key] = new WebAssembly.Global({ value: "f64", mutable: true }, baseVals[key]);
      });
    ...
    async loadWASMPreset(preset, blendTime) {
      ...
      for (let i = 0;i < preset.shapes.length; i++) {
        ...
        if (preset.shapes[i].baseVals.enabled !== 0) {
          wasmFunctions2[`shapes_${i}_init_eqs`] = {
            pool: `shapePerFrame${i}`,
            code: preset.shapes[i].init_eqs_eel
          };
          wasmFunctions2[`shapes_${i}_frame_eqs`] = {
            pool: `shapePerFrame${i}`,
      ...
      const mod2 = await srcExports.loadModule({
        pools: wasmVarPools,
        functions: wasmFunctions2,
        eelVersion: preset.version || 2
      });
      const handleEmptyFunction = (f) => {
        return f ? f : () => {};
      };
      const presetFunctionsMod = await ascLoader.instantiate(Visualizer.base64ToArrayBuffer(loadPresetFunctionsBuffer()), {
        pixelEqs: {
          perPixelEqs: handleEmptyFunction(mod2.exports.perPixel)
        },
        pixelVarPool: {
      ...
      preset.init_eqs = handleEmptyFunction(mod2.exports.presetInit);
      preset.frame_eqs = handleEmptyFunction(mod2.exports.perFrame);
      ...
      if (mod2.exports.perPixel) {
        preset.pixel_eqs = mod2.exports.perPixel;
      }
      ...
      for (let i = 0;i < preset.shapes.length; i++) {
        if (preset.shapes[i].baseVals.enabled !== 0) {
          preset.shapes[i].init_eqs = handleEmptyFunction(mod2.exports[`shapes_${i}_init_eqs`]);
          preset.shapes[i].frame_eqs = mod2.exports[`shapes_${i}_frame_eqs`];
      ...
      for (let i = 0;i < preset.waves.length; i++) {
        if (preset.waves[i].baseVals.enabled !== 0) {
          const wave = {
            init_eqs: handleEmptyFunction(mod2.exports[`waves_${i}_init_eqs`]),
            frame_eqs: handleEmptyFunction(mod2.exports[`waves_${i}_frame_eqs`])
          };
          if (preset.waves[i].point_eqs_eel && preset.waves[i].point_eqs_eel !== "") {
            wave.point_eqs = mod2.exports[`waves_${i}_point_eqs`];
          } else {
            wave.point_eqs = "";
          }
